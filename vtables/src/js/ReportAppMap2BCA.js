                ...
                ReactDOM.render(
                    <div>
                        <BootstrapTable data={output} striped={true} hover={true} search={true} pagination={true} exportCSV={true}>
                            ...
                            <TableHeaderColumn dataField="refName" dataAlign="left" dataSort={true} dataFormat={linkRef} filter={{ type: "TextFilter", placeholder: "Please enter a value" }}>BCA</TableHeaderColumn>   
                         </BootstrapTable>
                    </div>,
